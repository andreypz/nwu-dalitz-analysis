#ifndef natanalyzer_h
#define natanalyzer_h
...
#define nC 16
class natanalyzer : public TSelector {
 private:
  TFile* histoFile;
  TTree* thisTree;
 ...
 public :
  TTree          *fChain;   //!pointer to the analyzed TTree or TChain
   ...
   natanalyzer(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~natanalyzer() { }
   ...
   ClassDef(natanalyzer,1);
};

#endif

#ifdef natanalyzer_cxx
void natanalyzer::Init(TTree *tree)
{
