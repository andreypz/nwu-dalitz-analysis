...
os.system('root -l -b -q \'TrainMva.C("BDT,MLP", "hzz125", "allBg", 0, 0,0,0,0, "weights")\' > hzz250_allBg_0j.log')
os.system('root -l -b -q \'TrainMva.C("BDT,MLP", "hzz125", "allBg", 1, 0,0,0,0, "weights")\' > hzz250_allBg_1j.log')
os.system('root -l -b -q \'TrainMva.C("BDT,MLP", "hzz125", "allBg", 2, 0,0,0,0, "weights")\' > hzz250_allBg_2j.log')
