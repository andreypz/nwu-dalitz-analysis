...
ammagz::PhosphorCorrectionFunctor::PhosphorCorrectionFunctor(){

};//default constructor
ammagz::PhosphorCorrectionFunctor::PhosphorCorrectionFunctor(const char* filename){
...
ammagz::PhosphorCorrectionFunctor::PhosphorCorrectionFunctor(const char* filename, bool R9Cat){
...
double ammagz::PhosphorCorrectionFunctor::FabSmear(double E, double eta, double r9){
...
bool ammagz::PhosphorCorrectionFunctor::SetMapFileName(const char* filename){
this->filename = filename;

 return true;
};

bool ammagz::PhosphorCorrectionFunctor::CreateMap(){
...
bool ammagz::PhosphorCorrectionFunctor::CreateMap(bool R9Cat){
...
std::string ammagz::PhosphorCorrectionFunctor:: CreateMapKey(int Year, int DataType, int DetType, int CorrType, int PtBin){
...
std::string ammagz::PhosphorCorrectionFunctor:: CreateMapKey(int Year, int DataType, int DetType, int R9Cat, int CorrType, int PtBin){
...
double ammagz::PhosphorCorrectionFunctor::GetScaleCorr(int year, double pt, double eta){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEnergyMC(int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEnergyMC(float R9, int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEnergyData(int year, double pt, double etaReco){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEnergyData(float R9, int year, double pt, double etaReco){
...
/*
double ammagz::PhosphorCorrectionFunctor::GetCorrEnergy(int year, double pt, double etaReco, int datType){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEtMC(int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEtMC(float R9, int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEtData(int year, double pt, double etaReco){
...
double ammagz::PhosphorCorrectionFunctor::GetCorrEtData(float R9, int year, double pt, double etaReco){
...
/*
double ammagz::PhosphorCorrectionFunctor::GetCorrEt(int year, double pt, double etaReco, int datType){
...
int ammagz::PhosphorCorrectionFunctor::GetCategory(float R9, int year, double pt, double etaReco){
...
/*
  pair <int,double> ammagz::PhosphorCorrectionFunctor::ScaleEnError(float R9, int year, double pt, double etaReco, double Egen){
...
pair <int,double> ammagz::PhosphorCorrectionFunctor::ResEnError(float R9, int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::ScaleEnError(float R9, int year, double pt, double etaReco, double Egen){
...
double ammagz::PhosphorCorrectionFunctor::ResEnError(float R9, int year, double pt, double etaReco, double Egen){
...
bool ammagz::PhosphorCorrectionFunctor::MapCat(){
  //map<int, int> Map;
...
int ammagz::PhosphorCorrectionFunctor::GetCatNumber(int index){
  
  if( CatMap[index] >= 0 && CatMap[index] <= 24 )return CatMap[index];
  return -66;
};
int* ammagz::PhosphorCorrectionFunctor::CatIndex(float R9, int year, double pt, double etaReco){
