...
if selection == 'electron':
    ...
    if period in ['2011A', 'Combined']:
        data.extend([
        b.JobConfig('Mu_Aug05', dCache+'/naodell/Oct21/DoubleElectron_Aug05', 4, 'DATA 12,13,14 electron 2011A', selection),
        b.JobConfig('Mu_May10', dCache+'/andreypz/Data5/DoubleElectron_May10', 4, 'DATA 12,13 electron 2011A', selection),
        b.JobConfig('Mu_PromptV4', dCache+'/naodell/Oct21/DoubleElectron_PromptV4', 20, 'DATA 12,13,14 electron 2011A', selection),
        b.JobConfig('Mu_PromptV6', dCache+'/naodell/Oct21/DoubleElectron_PromptV6', 30, 'DATA 12,13,14 electron 2011A', selection)
        ])
    if period in ['2011B', 'Combined']:
        data.append(b.JobConfig('Mu_Run2011B', dCache+'/radek/Data3/DoubleElectron_Run2011B_PromptReco_v1', 30, 'DATA 14 electron 2011B', selection))
