...
void makePlot(Int_t sel=1, TString hPath="00")
{
  ...
  if(doPhotons){
    ...
    //TFile *fPhot = new TFile("./photonResult_070811_histo.root", "OPEN");
    //TFile *fPhot = new TFile("./photonResults_fullSample_071111.root", "OPEN");
    //TFile *fPhot = new TFile("./PhotonRun_110713a-weighted.root", "OPEN");
    //TFile *fPhot = new TFile("./PhotonRun_110714-1weighted.root", "OPEN");
    TFile *fPhot = new TFile("./PhotonRun_110715-1weighted.root", "OPEN");
    
    if (sel==1)  TString imgpath("~/afs/public_html/nwu/110715_photon/muon/");  
    if (sel==2)  TString imgpath("~/afs/public_html/nwu/110715_photon/electron/");  
    ...
    if(sel==1){
      ...
      AddPhoton(photon2_weighted_met_4, ph_met2_et[6], intLumi, usedLumi);
      
      AddPhoton(photon2_weighted_mt_0, ph_mt[5], intLumi, usedLumi);
      AddPhoton(photon2_weighted_mt_4, ph_mt[6], intLumi, usedLumi);
      AddPhoton(photon2_weighted_mt_6, ph_mt[7], intLumi, usedLumi);
      
      AddPhoton(photon2_weighted_nJets_0, ph_jet_N[5], intLumi, usedLumi);
      AddPhoton(photon2_weighted_nJets_4, ph_jet_N[6], intLumi, usedLumi);
      AddPhoton(photon1_weighted_nJets_6, ph_jet_N[7], intLumi, usedLumi);

      AddPhoton(photon2_weighted_metOverQt_0, ph_met_over_qt[5], intLumi, usedLumi);
      AddPhoton(photon2_weighted_metOverQt_4, ph_met_over_qt[6], intLumi, usedLumi);

      AddPhoton(photon2_weighted_metOverQt_0, ph_met2_over_qt[5], intLumi, usedLumi);
    ...
    drawMuliPlot("q_{T}", 1, 0.01, 100000, 0,2, hs_di_qt[4], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph02.png");
    
    drawMuliPlot("pfMET", 1, 0.01, 100000, 0,3, ph_met2_et[5], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph03.png");
    drawMuliPlot("pfMET", 1, 0.01, 100000, 0,3, hs_met2_et[5], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph04.png");
    
    drawMuliPlot("pfMET", 1, 0.001, 10000, 0,5, ph_met2_et[6], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph05.png");
    drawMuliPlot("pfMET", 1, 0.001, 10000, 0,5, hs_met2_et[6], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph06.png");
    
    drawMuliPlot("MT", 1, 0.001, 100000, 0,5, ph_mt[6], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph07.png");
    drawMuliPlot("MT", 1, 0.001, 100000, 0,5, hs_mt[6], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph08.png");
    
    
    drawMuliPlot("pfMet/q_{T}", 1, 0.001, 100000, 0,5, ph_met_over_qt[5], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph11.png");
    drawMuliPlot("pfMet/q_{T}", 1, 0.001, 100000, 0,5, hs_met2_over_qt[5], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph12.png");
    
    drawMuliPlot("pfMet/q_{T}", 1, 0.001, 100000, 0,5, ph_met_over_qt[6], c2, leg01, list_overlay, intLumi);
    c2 -> SaveAs(imgpath+"ph13.png");
    drawMuliPlot("pfMet/q_{T}", 1, 0.001, 100000, 0,5, hs_met2_over_qt[6], c2, leg01, list_overlay, intLumi);
