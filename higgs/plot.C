...
#define F2 2
  ...
  TH1F *data_met_phi[nCuts], *data_met_et[nCuts], *data_met_over_qt[nCuts], *data_di_qt[nCuts];

  TH1F *ZllG_met_phi[nCuts], *ZllG_met_et[nCuts], *ZllG_met_over_qt[nCuts], *ZllG_di_qt[nCuts];
  TH1F *Wjets_met_phi[nCuts], *Wjets_met_et[nCuts], *Wjets_met_over_qt[nCuts], *Wjets_di_qt[nCuts];
  TH1F *ZZtoAny_met_phi[nCuts], *ZZtoAny_met_et[nCuts], *ZZtoAny_met_over_qt[nCuts], *ZZtoAny_di_qt[nCuts];
  TH1F *ggH400_met_phi[nCuts], *ggH400_met_et[nCuts], *ggH400_met_over_qt[nCuts], *ggH400_di_qt[nCuts];
  TH1F *t_all_met_phi[nCuts], *t_all_met_et[nCuts], *t_all_met_over_qt[nCuts], *t_all_di_qt[nCuts];
  TH1F *tS_met_phi[nCuts], *tS_met_et[nCuts], *tS_met_over_qt[nCuts], *tS_di_qt[nCuts];
  TH1F *tT_met_phi[nCuts], *tT_met_et[nCuts], *tT_met_over_qt[nCuts], *tT_di_qt[nCuts];
  TH1F *tW_met_phi[nCuts], *tW_met_et[nCuts], *tW_met_over_qt[nCuts], *tW_di_qt[nCuts];
  TH1F *tt_met_phi[nCuts], *tt_met_et[nCuts], *tt_met_over_qt[nCuts], *tt_di_qt[nCuts];
  TH1F *WW_met_phi[nCuts], *WW_met_et[nCuts], *WW_met_over_qt[nCuts], *WW_di_qt[nCuts];
  TH1F *WZ_met_phi[nCuts], *WZ_met_et[nCuts], *WZ_met_over_qt[nCuts], *WZ_di_qt[nCuts];

  TH2F *data_met_et_ovQt[nCuts], *ZllG_met_et_ovQt[nCuts], *Wjets_met_et_ovQt[nCuts],*ZZtoAny_met_et_ovQt[nCuts],*ggH400_met_et_ovQt[nCuts],*t_all_met_et_ovQt[nCuts],*tS_met_et_ovQt[nCuts],*tT_met_et_ovQt[nCuts],*tW_met_et_ovQt[nCuts],*tt_met_et_ovQt[nCuts],*WW_met_et_ovQt[nCuts],*WZ_met_et_ovQt[nCuts],*DYmumu_met_et_ovQt[nCuts],*DYee_met_et_ovQt[nCuts],*DYtautau_met_et_ovQt[nCuts],*Zjets_met_et_ovQt[nCuts],*Zbb0_met_et_ovQt[nCuts],*Zbb1_met_et_ovQt[nCuts],*Zbb2_met_et_ovQt[nCuts],*Zbb3_met_et_ovQt[nCuts],*Zcc0_met_et_ovQt[nCuts],*Zcc1_met_et_ovQt[nCuts],*Zcc2_met_et_ovQt[nCuts],*Zcc3_met_et_ovQt[nCuts];
  //,*Z_met_et_ovQt[nCuts],*_met_et_ovQt[nCuts],*_met_et_ovQt[nCuts], 


  TH1F *DYmumu_met_phi[nCuts], *DYmumu_met_et[nCuts], *DYmumu_met_over_qt[nCuts], *DYmumu_di_qt[nCuts];
  TH1F *DYee_met_phi[nCuts], *DYee_met_et[nCuts], *DYee_met_over_qt[nCuts], *DYee_di_qt[nCuts];
  TH1F *DYtautau_met_phi[nCuts], *DYtautau_met_et[nCuts], *DYtautau_met_over_qt[nCuts], *DYtautau_di_qt[nCuts];
  TH1F *Zjets_met_phi[nCuts], *Zjets_met_et[nCuts], *Zjets_met_over_qt[nCuts], *Zjets_di_qt[nCuts];

  TH1F *Zbb0_met_phi[nCuts], *Zbb0_met_et[nCuts], *Zbb0_met_over_qt[nCuts], *Zbb0_di_qt[nCuts];
  TH1F *Zbb1_met_phi[nCuts], *Zbb1_met_et[nCuts], *Zbb1_met_over_qt[nCuts], *Zbb1_di_qt[nCuts];
  TH1F *Zbb2_met_phi[nCuts], *Zbb2_met_et[nCuts], *Zbb2_met_over_qt[nCuts], *Zbb2_di_qt[nCuts];
  TH1F *Zbb3_met_phi[nCuts], *Zbb3_met_et[nCuts], *Zbb3_met_over_qt[nCuts], *Zbb3_di_qt[nCuts];
  TH1F *Zcc0_met_phi[nCuts], *Zcc0_met_et[nCuts], *Zcc0_met_over_qt[nCuts], *Zcc0_di_qt[nCuts];
  TH1F *Zcc1_met_phi[nCuts], *Zcc1_met_et[nCuts], *Zcc1_met_over_qt[nCuts], *Zcc1_di_qt[nCuts];
  TH1F *Zcc2_met_phi[nCuts], *Zcc2_met_et[nCuts], *Zcc2_met_over_qt[nCuts], *Zcc2_di_qt[nCuts];
  TH1F *Zcc3_met_phi[nCuts], *Zcc3_met_et[nCuts], *Zcc3_met_over_qt[nCuts], *Zcc3_di_qt[nCuts];
  ...
  Float_t ev_ggH200   = 109274; //ok crab_0_110618_152127/
  Float_t ev_ggH400   = ggH400_met_et[0]   -> GetEntries();
  Float_t ev_ggH600   = 109274;
  ...
  THStack *hs_met_et[nCuts], *hs_met_over_qt[nCuts], *hs_di_qt[nCuts], *hs_met_et_ovQt[nCuts];
  TH1F *sum_met_et[nCuts], *sum_met_over_qt[nCuts], *sum_di_qt[nCuts];
  ...
  for(Int_t n=0; n<nCuts; n++)
      ...
      if(sel==2) 
	{
      ...
      */
      ...
      //drawOverflow(ggH400_di_qt[n]);
      //drawOverflow(ggH400_met_et[n]);
      //drawOverflow(ggH400_met_over_qt[n]);
      ...
      //drawOverflow(data_di_qt[n]);
      //drawOverflow(data_met_et[n]);
      //drawOverflow(data_met_over_qt[n]);
      //_met_et[n]      -> Scale(sc_);
  ...
  data_met_et_ovQt[F1] -> Draw("colz");
  data_met_et_ovQt[F1] -> SetTitle(";MET; MET/q_{T}");
  ...
  Double_t StoB = 0;
  Double_t signal = 0.1*ggH400_met_et[F0] ->Integral(7,41);
  Double_t backgr = sum_met_et[F0]->Integral(7,41);
  StoB = signal/backgr;
  cout<<StoB<<"  sig: "<<signal<<"  bg: "<<backgr<<endl;
  signal = 0.1*ggH400_met_et_ovQt[F1]->Integral(7, 41, 0,41);
  backgr = sum_met_et_ovQt[F1]->Integral(7, 41, 0,41);
  StoB = signal/backgr;
  cout<<StoB<<"  sig: "<<signal<<"  bg: "<<backgr<<endl;


  signal = 0.1*ggH400_met_et_ovQt[F0]->Integral(7, 41, 0,41);
  backgr = sum_met_et_ovQt[F0]->Integral(7, 41, 0,41);
  StoB = signal/backgr;
  cout<<StoB<<"  sig: "<<signal<<"  bg: "<<backgr<<endl;
