...
Float_t getXsecOrColors(string dataset="ggHZZ300", Int_t b = 1)
{
  ...
  else if(dataset=="tbarW")    {lCol = kRed;      fCol = kWhite;   cs = 7.87; }
  ...
  else if(dataset=="ggHZZ450") {lCol = kYellow;   fCol  = -1; cs = 0.0143; }
  else if(dataset=="ggHZZ500") {lCol = kYellow;   fCol  = -1; cs = 0.00896; }
  else if(dataset=="ggHZZ550") {lCol = kYellow;   fCol  = -1; cs = 0.00568; }
